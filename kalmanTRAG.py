                ...
                for i2 in range(ncel2):
                    for i1 in range(ncel1):
                        ...
                        for k, zk in reversed(list(enumerate(VZI))[:-1]):  # iplanN; z / mm
                            ...
                            print(f'Chi2 = {Chi2}')
        phits = 4
        kx3, ky3, kt3, _, _, _ = self.set_params(0, 3)
        kx2, ky2, kt2, _, _, _ = self.set_params(0, 2)
        kx1, ky1, kt1, _, _, _ = self.set_params(0, 1)
        kx0, ky0, kt0, _, _, _ = self.set_params(0, 0)
        vr4 = self.r[0, 0]
        mstat = np.hstack([phits, kx3, ky3, kt3, kx2, ky2, kt2, kx1, ky1, kt1, kx0, ky0, kt0, vr4, Chi2])
        return mstat
